<template>
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      <input type="text" v-model="searchQuery" @input="getSearchResults" placeholder="Wyszukaj miasto lub stan"
      ...
      <ul class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]"
        ...
        <p class="py-2" v-if="!searchError && mapboxSearchResults.length === 0">
          Brak wyników pasujących do Twojego zapytania. Spróbuj innego hasła.
        </p>
        <template v-else>
